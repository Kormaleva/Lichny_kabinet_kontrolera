...
.. image:: ./Pictures/Lichny_kabinet_kontrolera_vvedenie/Окно_входа_в_программу_Иванов.png

 
В Личном кабинете контролера есть два рабочих места: *Приборы учета* и *Документы*.

.. image:: ./Pictures/Lichny_kabinet_kontrolera_vvedenie/Рабочие_места.png
...
.. image:: ./Pictures/Lichny_kabinet_kontrolera_vvedenie/Интерфейсы_РМ_Приборы_учета.png
...
.. image:: ./Pictures/Lichny_kabinet_kontrolera_vvedenie/Интерфейс_РМ_Документы.png
